(function() {
  var Access, Arr, Assign, Base, BaseValue, Block, BooleanValue, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NumberValue, Obj, Op, Param, Parens, Push, Range, RangeValue, Return, SIMPLENUM, Scope, Slice, Splat, StringValue, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, VectorValue, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.BaseValue = BaseValue = (function() {
    ...
    BaseValue.prototype.compileNode = function(o) {
      return this.value;
    };
    return BaseValue;
  })();
  ...
  exports.VectorValue = VectorValue = (function() {
    ...
    VectorValue.prototype.compileNode = function(o) {
      var code, obj, objs;
  ...
  exports.RangeValue = RangeValue = (function() {
    ...
    RangeValue.prototype.compileNode = function(o) {
      var code, obj;
      code = ((function() {
