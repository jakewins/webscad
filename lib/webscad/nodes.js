(function() {
  var Assign, Base, BaseValue, Block, BooleanValue, Code, Comment, Conditional, FunctionCall, IDENTIFIER, IDENTIFIER_STR, IS_STRING, Identifier, If, IndexAccess, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, MemberAccess, Module, ModuleCall, NEGATE, NO, NumberValue, Op, Range, RangeValue, Return, SIMPLENUM, Scope, StringValue, TAB, THIS, UndefinedValue, Value, VectorValue, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, utility, _ref;
