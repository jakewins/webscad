(function() {
  var Assign, Base, BaseValue, Block, BooleanValue, Code, Comment, Conditional, FunctionCall, IDENTIFIER, IDENTIFIER_STR, IS_STRING, Identifier, If, Include, IndexAccess, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, MemberAccess, Module, ModuleCall, NEGATE, NO, NumberValue, Op, Range, RangeValue, Return, SIMPLENUM, Scope, StringValue, TAB, THIS, UndefinedValue, Use, Value, VectorValue, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, utility, _ref;
  ...
  exports.ModuleCall = ModuleCall = (function() {
    ...
    function ModuleCall(name, args, subModules) {
      this.name = name;
      this.args = args != null ? args : [];
  ...
  exports.Module = Module = (function() {
    ...
    function Module(variable, body) {
      this.variable = variable;
      this.body = body != null ? body : new Block;
      this.boundFuncs = [];
      this.body.classBody = true;
    }
    Module.prototype.children = ['variable', 'body'];
    return Module;
  })();
