  ...
  */
  ...
  exports.Face = Face = (function() {
    ...
    Face.prototype.toString = function() {
      return "Face[halfEdge=(" + (this.halfEdge.vertex.toString()) + ")]";
    };
  ...
  exports.PolyhedronBuilder = PolyhedronBuilder = (function() {
    ...
    */
    ...
    PolyhedronBuilder.fromPolygons = function(polygons) {
      var builder, faceIsDegenerated, fc, i, point, polygon, v, vertex, vertexIds, vertexes, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n;
      vertexes = [];
      vertexIds = new Grid;
      ...
      i = 0;
      for (_k = 0, _len2 = vertexes.length; _k < _len2; _k++) {
        vertex = vertexes[_k];
      ...
      i = 1;
      for (_l = 0, _len3 = polygons.length; _l < _len3; _l++) {
        polygon = polygons[_l];
        ...
        for (_n = 0, _len5 = polygon.length; _n < _len5; _n++) {
          point = polygon[_n];
          if (!faceIsDegenerated) {
            if (DEBUG) {
    ...
    PolyhedronBuilder.prototype.addVertexToFace = function(v2) {
      ...
      if (!(this.vertexToEdgeMap[this.v1] != null)) {
        ...
        if (b1 && b2) {
          ...
          if (this.h1.oppositeface !== h2.oppositeface) {
      ...
      if (this.vertexToEdgeMap[startVertexId] != null) {
        ...
        while (startEdge !== he && !first) {
          ...
          if (he.next.vertex === endVertex) {
            ...
            if ((this.currentFace != null) && this.currentFace === he.next.oppositeface) {
