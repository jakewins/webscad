(function() {
  var Assign, Base, BaseValue, Block, BooleanValue, Code, Comment, Conditional, Context, FunctionCall, IDENTIFIER, IDENTIFIER_STR, IS_STRING, Identifier, If, Include, IndexAccess, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, MemberAccess, Module, ModuleCall, NEGATE, NO, NumberValue, Op, Range, RangeValue, Return, SIMPLENUM, StringValue, TAB, THIS, TreeNode, UndefinedValue, Use, Value, VectorValue, YES, compact, csg, del, ends, extend, flatten, last, merge, multident, starts, utility, _ref;
  ...
  exports.ModuleCall = ModuleCall = (function() {
    ...
    ModuleCall.prototype.evaluate = function(ctx) {
      ...
      return ctx.getModule(this.name).evaluate(ctx, childevals);
    };
    return ModuleCall;
  })();
