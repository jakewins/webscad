(function() {
  ...
  operators = [['left', '.'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['right', '!'], ['left', '*', '/', '%'], ['left', '+', '-'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', 'LOGIC'], ['left', '?'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', '=', 'COMPOUND_ASSIGN'], ['right', 'IF', 'ELSE', 'MODULE'], ['right', 'POST_IF']];
  tokens = [];
  for (name in grammar) {
