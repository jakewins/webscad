      ...
      if (!(this.vertexToEdgeMap[this.prevVertex] != null)) {
        ...
        if (prevIsBorder && nextIsBorder) {
          ...
          if (halfEdgeAfterPrevious !== nextHalfEdge) {
            ...
            console.log(this.currentFaceStateToString());
...
};require['./threerender'] = new function() {
  var exports = this;
  // Generated by CoffeeScript 1.3.3
(function() {
  var Grid, ScadFaceToThreeFacesConverter, Three, ThreeGeometryBuilder, ThreeRenderer,
  ...
  exports.ThreeGeometryBuilder = ThreeGeometryBuilder = (function() {
    ...
    ThreeGeometryBuilder.prototype.addFace = function(v1, v2, v3, v4) {
      ...
      face.materialIndex = this.currentMaterialIdx;
      this.currentMaterialIdx = this.currentMaterialIdx >= (this.materials.length - 2) ? 0 : this.currentMaterialIdx++;
      console.log(this.currentMaterialIndex);
      return this.faces.push(face);
    };
    ...
    ThreeGeometryBuilder.prototype._getOrCreateV = function(point) {
      if (!this.verticeMap.has(point)) {
        ...
        this.vertexes.push(new Three.Vector3(point[0], point[1], point[2]));
      }
